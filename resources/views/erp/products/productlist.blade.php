                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('product.list') }}" method="GET" id="filterForm" autocomplete="off">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-2">
                                    <label class="form-label small fw-bold text-muted text-uppercase mb-2">Style
                                        Number</label>
                                    <select name="style_number" class="form-select select2-simple"
                    ...
                    <div class="card-footer bg-light border-top p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex gap-2">
                                <a href="{{ route('product.export.excel', request()->all()) }}"
                                    class="btn btn-outline-success btn-sm fw-bold px-3 no-loader export-link-excel"
                                    target="_blank">
                                    <i class="fas fa-file-excel me-2"></i>Excel
                                </a>
                                <a href="{{ route('product.export.pdf', request()->all()) }}"
                                    class="btn btn-outline-danger btn-sm fw-bold px-3 no-loader export-link-pdf"
                                    target="_blank">
