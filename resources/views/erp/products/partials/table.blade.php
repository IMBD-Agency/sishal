    ...
    <div class="premium-card shadow-sm">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a href="{{ route('product.show', $product->id) }}"
                                            class="btn btn-info btn-xs text-white" title="View"><i
                                                class="fas fa-eye fa-xs"></i></a>
                                        @can('edit products')
                                            <a href="{{ route('product.edit', $product->id) }}" class="btn btn-success btn-xs"
                                                title="Edit"><i class="fas fa-edit fa-xs"></i></a>
                                        @endcan
                                        @can('delete products')
        ...
        <div class="card-footer bg-white border-top-0 py-2 px-3">
            <div class="d-flex justify-content-between align-items-center">
                <p class="text-muted small mb-0">Showing {{ $products->firstItem() }} to {{ $products->lastItem() }} of
