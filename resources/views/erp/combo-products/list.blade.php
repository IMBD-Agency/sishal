        ...
        <div class="glass-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-5 text-md-end mt-3 mt-md-0">
                    @can('manage combos')
                        <a href="{{ route('erp.combo-products.create') }}" class="btn btn-primary px-4"
                ...
                <div class="card-body p-3">
                    <form action="{{ route('erp.combo-products.index') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control border-start-0 ps-0"
                                    placeholder="Search combo name or SKU..." value="{{ request('search') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <a href="{{ route('erp.combo-products.index') }}" class="btn btn-outline-secondary px-4"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($combo->combo_original_price > $combo->price)
                                                <br>
                                                <small class="text-success">Save
                                                    ৳{{ number_format($combo->combo_original_price - $combo->price, 2) }}</small>
                                            @endif
                                        </td>
                                        <td>
                                            @php
                                            ...
                                            @endphp
                                            @if($stock <= 0)
                                                <span class="badge bg-danger bg-opacity-10 text-danger border py-1 px-2"
                                                    style="font-weight: 600;">
                                                    <i class="fas fa-times-circle me-1"></i> Out of Stock
                                                </span>
                                            @elseif($stock <= 5)
                                                <span class="badge bg-warning bg-opacity-10 text-warning border py-1 px-2"
                                                    style="font-weight: 600;">
                                                    <i class="fas fa-exclamation-triangle me-1"></i> Low Stock ({{ $stock }})
                                                </span>
                                            @else
                                                <span class="badge bg-success bg-opacity-10 text-success border py-1 px-2"
                                                    style="font-weight: 600;">
                                        ...
                                        <td class="text-end pe-4">
                                            ...
                                            @endcan
                                            @can('manage combos')
                                                <form action="{{ route('erp.combo-products.delete', $combo) }}" method="POST"
                                                    class="d-inline"
                                                    onsubmit="return confirm('Are you sure you want to delete this combo? All items will be removed.')">
                                                    @csrf
                                                    @method('DELETE')
