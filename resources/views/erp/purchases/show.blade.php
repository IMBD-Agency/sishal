        ...
        <div class="print-invoice-container">
            <div class="invoice-header">
                <div class="company-info">
                    @php $logo = ($general_settings->site_logo ?? null) ? asset($general_settings->site_logo) : asset('static/logo.png'); @endphp
                ...
                <div class="invoice-title-block">
                    ...
                    <p class="text-muted small">Date: {{ $purchase->purchase_date ? \Carbon\Carbon::parse($purchase->purchase_date)->format('d/m/Y') : '-' }}</p>
                </div>
            </div>
