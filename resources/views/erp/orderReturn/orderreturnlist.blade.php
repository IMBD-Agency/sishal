                ...
                <div class="card-body p-3">
                    <form id="filterForm" action="{{ route('orderReturn.list') }}" method="GET" autocomplete="off">
                        ...
                        <div class="row g-2 align-items-end">
                            ...
                            <!-- Monthly Fields -->
                            <div class="col-md-4 report-field monthly-group {{ request('report_type', 'yearly') !== 'monthly' ? 'd-none' : '' }}">
                                <div class="row g-2">
                                    <div class="col-6">
                            ...
                            <!-- Yearly Fields -->
                            <div class="col-md-2 report-field yearly-group {{ request('report_type', 'yearly') !== 'yearly' ? 'd-none' : '' }}">
                                <label class="form-label small fw-bold text-muted text-uppercase mb-1">Select Year</label>
                                <select name="year" class="form-select form-select-sm">
                                    @foreach(range(date('Y'), date('Y') - 10) as $y)
                                        <option value="{{ $y }}" {{ (request('year') ?? date('Y')) == $y ? 'selected' : '' }}>{{ $y }}</option>
