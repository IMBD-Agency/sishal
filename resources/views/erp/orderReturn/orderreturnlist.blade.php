            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    <div class="btn-group shadow-sm">
                        ...
                        <a href="{{ route('orderReturn.export.pdf', request()->query()) }}"
                            class="btn btn-outline-danger btn-sm fw-bold export-link-pdf">
                            <i class="fas fa-file-pdf me-1"></i>PDF
                        </a>
                        <a href="{{ route('orderReturn.export.excel', request()->query()) }}"
                            class="btn btn-outline-success btn-sm fw-bold export-link-excel">
                ...
                <div class="card-body p-3">
                    <form id="filterForm" action="{{ route('orderReturn.list') }}" method="GET" autocomplete="off">
                        ...
                        <div class="row g-2 align-items-end">
                            ...
                            <!-- Daily Fields -->
                            <div
                                class="col-md-2 report-field daily-group {{ request('report_type', 'yearly') !== 'daily' ? 'd-none' : '' }}">
                            ...
                            <!-- Monthly Fields -->
                            <div
                                class="col-md-4 report-field monthly-group {{ request('report_type', 'yearly') !== 'monthly' ? 'd-none' : '' }}">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <label class="form-label small fw-bold text-muted text-uppercase mb-1">Select
                                            Month</label>
                            ...
                            <!-- Yearly Fields -->
                            <div
                                class="col-md-2 report-field yearly-group {{ request('report_type', 'yearly') !== 'yearly' ? 'd-none' : '' }}">
                            ...
                            <div class="col-md-auto ms-auto">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('orderReturn.list') }}"
                                        class="btn btn-light border btn-sm px-4 fw-bold shadow-sm">
                ...
                <form id="statusForm">
                    ...
                    <div class="modal-body px-4 pb-4">
                        ...
                        <div class="mb-3" id="modalAccountWrapper" style="display:none;">
                            <label class="form-label fw-semibold">Deduct From Account <span
                            ...
                            <select class="form-select border-2" name="account_id" id="modalAccountId">
                                ...
                                @foreach($bankAccounts as $account)
                                    <option value="{{ $account->id }}">{{ $account->provider_name ?? ucfirst($account->type) }}
                        ...
                        <div class="form-text text-danger mt-2 mb-3" id="stockWarning" style="display:none;">
                            <i class="fas fa-exclamation-triangle me-1"></i> Marking as Processed will increment inventory
                            levels!
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-semibold">Notes</label>
                            <textarea class="form-control" name="notes" id="statusNotes" rows="3"
                                placeholder="Explain status change..."></textarea>
                        </div>
                    </div>
