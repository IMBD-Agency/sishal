                        ...
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="search" value="{{ request('search') }}"
                                    placeholder="Name, Email, Phone, Company, Tax #...">
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="card-footer bg-light border-top p-3 mt-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex gap-2">
                                    <a href="{{ route('suppliers.index', array_merge(request()->all(), ['export' => 'excel'])) }}"
                                        class="btn btn-outline-success btn-sm fw-bold px-3 no-loader" target="_blank">
                                        <i class="fas fa-file-excel me-2"></i>Excel
                                    </a>
                                    <a href="{{ route('suppliers.index', array_merge(request()->all(), ['export' => 'pdf'])) }}"
                                        class="btn btn-outline-danger btn-sm fw-bold px-3 no-loader" target="_blank">
            ...
            <div class="d-flex justify-content-end align-items-center mb-3">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <input type="text" id="tableSearch" class="form-control form-control-sm table-search-input"
                        placeholder="Quick Search..." style="width: 250px;">
                </div>
            </div>
            ...
            <div class="premium-card shadow-sm border-0">
                <div class="card-header bg-white border-bottom p-3 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold mb-0 text-uppercase text-muted small"><i
                            class="fas fa-truck me-2 text-primary"></i>Supplier Audit Registry</h6>
                </div>
                                    ...
                                    <tr>
                                        <td class="ps-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle-sm me-2 bg-soft-primary text-primary d-flex align-items-center justify-content-center rounded-circle fw-bold shadow-sm"
                                                    style="width: 32px; height: 32px; background-color: #eef2ff; font-size: 11px;">
                                        ...
                                        <td class="text-end fw-bold">
                                            ...
                                            <span
                                                class="{{ $balance > 0 ? 'text-danger' : ($balance < 0 ? 'text-primary' : 'text-muted') }}">
                                                {{ number_format(abs($balance), 2) }}
                                                <small
                                                    class="ms-1 fw-normal opacity-75">{{ $balance > 0 ? 'DUE' : ($balance < 0 ? 'ADV' : '') }}</small>
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-center pe-3">
                                            <div class="d-flex justify-content-end gap-1">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul
                                                        class="dropdown-menu dropdown-menu-end border-0 shadow-lg premium-dropdown">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('suppliers.show', $supplier->id) }}"><i
                                                                    class="fas fa-eye me-2 text-primary"></i>View Profile</a>
                                                        </li>
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('suppliers.ledger', $supplier->id) }}"><i
                                                                    class="fas fa-list-alt me-2 text-warning"></i>Ledger
                                                                History</a></li>
                                                        @can('edit suppliers')
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('suppliers.edit', $supplier->id) }}"><i
                                                                        class="fas fa-edit me-2 text-info"></i>Edit Details</a></li>
                                                        @endcan
                                                        <li>
        ...
        @push('scripts')
            ...
            <style>
                ...
                .table-responsive {
                    ...
                    /* Allow vertical overflow while keeping horizontal scrolling */
                    padding-bottom: 80px;
                    /* Buffer for dropdowns */
                    min-height: 400px;
                    /* Ensure space for short tables */
                }

                .premium-dropdown {
                    z-index: 1060 !important;
                    /* Above table headers and other fixed elements */
                }
            </style>
        @endpush
@endsection