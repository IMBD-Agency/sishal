    ...
    <div class="main-content bg-light min-vh-100" id="mainContent">
        ...
        <div class="container-fluid px-4 py-4">
                                ...
                                @if(count($branches) > 0)
                                    <div class="col-md-2">
                                        ...
                                        <select name="branch_id"
                                            class="form-select form-select-sm filter-select select2-premium-42">
                    ...
                    <div class="card-footer bg-light border-top p-3 mt-4 mx-n4 mb-n4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex gap-2">
                                <a href="{{ route('salary.export.excel', request()->all()) }}"
                                    class="btn btn-outline-success btn-sm fw-bold px-3 shadow-sm no-loader">
                                    <i class="fas fa-file-excel me-2"></i>Excel
                                </a>
                                <a href="{{ route('salary.export.pdf', request()->all()) }}"
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="fw-bold mb-0 text-uppercase text-muted small"><i class="fas fa-list me-2 text-primary"></i>Salary
                    Registry List</h6>
                <div class="search-wrapper-premium" style="width: 300px;">
                    <input type="text" id="customSearch"
                        class="form-control rounded-pill search-input-premium table-search-input"
                            ...
                            <tbody>
                                @forelse($payments as $index => $payment)
                                    <tr id="row-{{ $payment->id }}">
                                        ...
                                        <td class="fw-bold">{{ $payment->employee->user->first_name }}
                                            {{ $payment->employee->user->last_name }}</td>
                                        ...
                                        <td class="text-end text-warning">
                                            {{ number_format($payment->festival_bonus_amount, 2) }}৳</td>
                                        ...
                                        <td class="text-center pe-3">
                                            <div class="d-flex gap-2 justify-content-center">
                                                <a href="{{ route('salary.show', $payment->id) }}"
                                                    class="action-circle bg-light" title="View">
                                ...
                                <tfoot class="bg-light fw-bold">
                                    <tr>
                                        ...
                                        <td class="text-end text-success">
                                            {{ number_format($payments->sum('bonus_amount'), 2) }}৳</td>
                                        <td class="text-end text-warning">
                                            {{ number_format($payments->sum('festival_bonus_amount'), 2) }}৳</td>
                                        <td class="text-end text-primary">
                                            {{ number_format($payments->sum('paid_amount') + $payments->sum('bonus_amount') + $payments->sum('festival_bonus_amount'), 2) }}৳
                                        </td>
                                        <td colspan="3"></td>
                                    </tr>
                                </tfoot>
