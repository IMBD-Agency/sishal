            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-4 px-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="btn-group">
                                <a href="{{ route('pos.export.pdf', array_merge(request()->all(), ['columns' => 'pos_id,sale_date,customer,phone,branch,status,payment_status,total,paid_amount,due_amount', 'action' => 'print'])) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-print me-1"></i> Print
                                </a>
                                <a href="{{ route('pos.export.excel', array_merge(request()->all(), ['columns' => 'pos_id,sale_date,customer,phone,branch,status,payment_status,total,paid_amount,due_amount'])) }}" class="btn btn-sm btn-outline-success">
                                    <i class="fas fa-file-excel me-1"></i> Excel
                                </a>
                                <a href="{{ route('pos.export.pdf', array_merge(request()->all(), ['columns' => 'pos_id,sale_date,customer,phone,branch,status,payment_status,total,paid_amount,due_amount'])) }}" class="btn btn-sm btn-outline-danger">
