<div class="table-responsive">
    <table class="table premium-table compact reporting-table table-bordered mb-0" id="salesTable">
        ...
        <tbody>
            ...
            if (str_contains($attrName, 'color') || (isset($val->attribute) && $val->attribute->is_color)) $color =
            $val->value;
        ...
        <tfoot class="bg-light fw-bold">
            <tr class="bg-soft-primary border-top-2">
                @php
                $colBeforeQty = (auth()->user()->hasRole('Super Admin') || auth()->user()->hasPermissionTo('delete
                sales')) ? 17 : 16;
                @endphp
