...
@section('title', 'Onboard New Personnel')
            ...
            <div class="col-md-7">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1" style="font-size: 0.85rem;">
                        ...
                        <li class="breadcrumb-item active text-primary fw-600">Onboard Personnel</li>
                    </ol>
                </nav>
                <h4 class="fw-bold mb-0 text-dark">Personnel Registration</h4>
                <p class="text-muted small mb-0">Create new user accounts and assign operational roles</p>
            </div>
            ...
            <div class="col-lg-10">
                <div class="premium-card">
                    <div class="card-header bg-white border-bottom p-4">
                        <h5 class="fw-bold mb-0"><i class="fas fa-user-plus me-2 text-primary"></i>Employee Profile Form</h5>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('employees.store') }}">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name') }}" required placeholder="e.g. John">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="last_name" name="last_name" value="{{ old('last_name') }}" required placeholder="e.g. Doe">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" required placeholder="+880 1XXX-XXXXXX">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Security & Access -->
                                <div class="col-md-6">
                                    <h6 class="text-muted text-uppercase fw-bold small mb-3">Security & Access Control</h6>
