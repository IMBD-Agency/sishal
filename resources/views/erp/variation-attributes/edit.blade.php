        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('erp.variation-attributes.update', $attribute->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $attribute->slug) }}" required>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="is_color" name="is_color" value="1" {{ old('is_color', $attribute->is_color) ? 'checked' : '' }}>
                                                ...
                                                <div class="value-row mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="values[{{ $index }}][value]" value="{{ old('values.' . $index . '.value', $value->value) }}" required>
                                                        </div>
                                                        <div class="col-md-4 color-field" style="display: {{ old('is_color', $attribute->is_color) ? 'block' : 'none' }};">
                                                            <label class="form-label">Color Code</label>
                                                            <input type="color" class="form-control form-control-color" name="values[{{ $index }}][color_code]" value="{{ old('values.' . $index . '.color_code', $value->color_code) }}">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label class="form-label">Image</label>
                                                            <input type="file" class="form-control" name="values[{{ $index }}][image]" accept="image/*">
                                                            @if($value->image)
                                                                <small class="text-muted d-block mt-1">Current: {{ $value->image }}</small>
                                                            @endif
                                                        </div>
                                                    </div>
...
@push('scripts')
<script>
let valueIndex = {{ max( ($attribute->values->count() ?? 0), 0) }};
