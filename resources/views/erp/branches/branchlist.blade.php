                ...
                <form id="filterForm" class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="search-wrapper">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Name, Location..."
                                value="{{ request('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4 d-flex align-items-end gap-2">
                        <button type="submit" class="btn px-4 w-100 fw-bold"
                            style="background: var(--primary-color); color: white; border-radius: 10px; height: 42px;">
                            <i class="fas fa-filter me-2"></i>Apply Filters
                        </button>
                        <button type="button" class="btn btn-light px-4 w-100 fw-bold border" id="resetFilter"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content border-0" style="border-radius: 20px; overflow: hidden;">
                    ...
                    <div class="modal-body p-4">
                        <p class="text-muted mb-4">Customize your export by selecting the data points you need for your
                            branch network report.</p>

                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="form-check p-3 border rounded-3 h-100">
                                    <input class="form-check-input ms-0 me-2 column-selector" type="checkbox" value="id"
                                        id="col_id" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check p-3 border rounded-3 h-100">
                                    <input class="form-check-input ms-0 me-2 column-selector" type="checkbox" value="name"
                                        id="col_name" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check p-3 border rounded-3 h-100">
                                    <input class="form-check-input ms-0 me-2 column-selector" type="checkbox"
                                        value="location" id="col_location" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check p-3 border rounded-3 h-100">
                                    <input class="form-check-input ms-0 me-2 column-selector" type="checkbox"
                                        value="contact_info" id="col_contact_info" checked>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <button type="button" class="btn btn-link px-0 text-decoration-none fw-bold"
                                    id="selectAllColumns" style="color: var(--primary-color);">Select All Channels</button>
                            </div>
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-success px-4" id="exportExcel"
                                    style="border-radius: 10px;">
                                    <i class="fas fa-file-excel me-2"></i>Excel
                                </button>
                                <button type="button" class="btn btn-danger px-4" id="exportPdf"
                                    style="border-radius: 10px;">
