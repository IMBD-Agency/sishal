                ...
                <div class="form-card p-4 p-md-5">
                    ...
                    <form method="POST" action="{{ route('branches.store') }}">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="warehouse_id" class="form-label">Parent Warehouse (Stock Source)</label>
                                <div class="input-icon">
                            ...
                            <div class="col-md-6">
                                <label for="manager_id" class="form-label">Assign Branch Manager</label>
                                <div class="input-icon">
                                    <select class="form-select @error('manager_id') is-invalid @enderror" id="manager_id" name="manager_id">
                                        <option value="">-- No Manager Assigned --</option>
                                        @foreach($employees as $employee)
                                            <option value="{{ $employee->user_id }}" {{ old('manager_id') == $employee->user_id ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="switch-premium shadow-sm">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div class="form-check form-switch p-0">
                                            <input class="form-check-input ms-0" type="checkbox" id="is_warehouse" name="is_warehouse" value="1" {{ old('is_warehouse', false) ? 'checked' : '' }} style="width: 3rem; height: 1.5rem;">
                                        </div>
                                    </div>
