                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2">
                        ...
                        @can('manage exchange')
                            <form action="{{ route('exchange.delete', $exchange->id) }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to delete this exchange? Stock and accounting will be fully rolled back!')"
            ...
            <div class="row g-4">
                <div class="col-lg-4 d-flex flex-column gap-4">
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3"><i class="fas fa-info-circle text-primary me-2"></i>Summary
                            </h5>
                            <div class="bg-light rounded-3 p-3">
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">Exchange Date</span>
                                    <span
                                        class="fw-bold">{{ \Carbon\Carbon::parse($exchange->exchange_date)->format('d M Y') }}</span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">Original Sale</span>
                                    <a href="{{ route('pos.show', $exchange->original_pos_id) }}"
                                        class="fw-bold text-decoration-none">{{ $exchange->originalPos->sale_number ?? '-' }}</a>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="fw-bold">{{ $exchange->employee->user->first_name ?? '' }}
                                        {{ $exchange->employee->user->last_name ?? '' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3"><i class="fas fa-wallet text-success me-2"></i>Financials
                            </h5>
                            <div class="bg-light rounded-3 p-3">
                                <div class="d-flex justify-content-between mb-2">
                                ...
                                @if($exchange->extra_payable > 0)
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        ...
                                        <span
                                            class="fw-bold fs-5 text-success">{{ number_format($exchange->extra_payable, 2) }}৳</span>
                                    </div>
                                @elseif($exchange->refund_amount > 0)
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        <span class="fw-bold text-dark">Refunded to Customer</span>
                                        <span
                                            class="fw-bold fs-5 text-danger">{{ number_format($exchange->refund_amount, 2) }}৳</span>
                                    </div>
                                @else
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3 text-danger"><i class="fas fa-undo me-2"></i>Returned Items
                            </h5>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold mb-3 text-success"><i class="fas fa-plus-circle me-2"></i>New
                                Items Given</h5>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead class="bg-light">
