    ...
    <div class="main-content bg-gray-50 min-vh-100" id="mainContent">
        ...
        <div class="container-fluid px-4 py-4">
                        ...
                        <a href="{{ route('category.list') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-primary bg-opacity-10 text-primary rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
            ...
            @endcan
                ...
                @can('product brand')
                    ...
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('brands.index') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-success bg-opacity-10 text-success rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
                ...
                @can('product unit')
                    ...
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('units.index') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-info bg-opacity-10 text-info rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
                ...
                @can('product season')
                    ...
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('seasons.index') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-warning bg-opacity-10 text-warning rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
                                        <i class="fas fa-cloud-sun fa-2x"></i>
                                    </div>
                                    <h5 class="fw-bold text-dark mb-1">Product Season</h5>
                                    <p class="text-muted small mb-3">Seasonal collections</p>
                                    <div class="badge bg-warning text-dark rounded-pill px-3">{{ $stats['seasons'] }} Items
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                @can('product gender')
                    ...
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('genders.index') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-danger bg-opacity-10 text-danger rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
                ...
                @can('product variation')
                    <!-- Variation Attributes (Color/Size) -->
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('erp.variation-attributes.index') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-secondary bg-opacity-10 text-secondary rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
                                        <i class="fas fa-sliders-h fa-2x"></i>
                                    </div>
                                    <h5 class="fw-bold text-dark mb-1">Style/Variation</h5>
                                    <p class="text-muted small mb-3">Colors, Sizes, and more</p>
                                    <div class="badge bg-secondary rounded-pill px-3">{{ $stats['variation_attributes'] }} Items
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                @can('product attribute')
                    <!-- General Attributes -->
                    <div class="col-md-4 col-xl-3">
                        <a href="{{ route('attribute.list') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm rounded-4 h-100 transition-up overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    <div class="icon-box bg-dark bg-opacity-10 text-dark rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center shadow-sm"
                                        style="width: 70px; height: 70px;">
