...
<head>
    ...
    <title>500 - Server Error | {{ config('app.name', 'ERP') }}</title>
...
<body>
    <div class="error-card">
        <div class="icon-container">
            <i class="fas fa-triangle-exclamation main-icon"></i>
            <span class="badge-500">500</span>
        </div>
        ...
        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
            <button type="button" class="btn-secondary-action" onclick="window.location.reload()">
                <i class="fas fa-rotate-right me-2"></i>Reload Page
            </button>
