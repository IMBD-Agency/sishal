...
<head>
    ...
    <title>405 - Method Not Allowed | {{ config('app.name', 'ERP') }}</title>
...
<body>
    <div class="error-card">
        <div class="icon-container">
            <i class="fas fa-ban main-icon"></i>
            <span class="badge-405">405</span>
        </div>

        <h1 class="error-title">Method Not Allowed</h1>
        <p class="error-subtitle mb-4">
            The request method used is not supported for this action. Please return to a valid page.
        </p>
        ...
        <div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
            ...
            <a href="{{ auth()->check() ? route('erp.dashboard') : url('/') }}" class="btn-primary-action">
