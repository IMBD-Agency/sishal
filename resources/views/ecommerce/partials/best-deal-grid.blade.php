        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="product-card position-relative h-100" 
                ...
                <div class="product-image-container">
                    <img src="{{ $product->image ?: '/static/default-product.jpg' }}" class="product-image" alt="{{ $product->name }}" loading="lazy">
                </div>
                <div class="product-info">
                    ...
                    <div class="d-flex justify-content-between align-items-center gap-2 product-actions">
                        ...
                        @endphp
                        <a href="{{ route('product.details', $product->slug) }}" class="btn-add-cart" style="text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
@else
    <div class="col-12">
        <div class="no-products-container">
            ...
            <p class="no-products-message">We couldn't find any best deal products.</p>
        </div>
    </div>
@endif
